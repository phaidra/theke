...
export default {
  ...
  'schema:subtitleLanguage': 'Untertitelsprache',
  ...
  // c18n
  'bf:supplementaryContent': 'Extras',
  'bf:awards': 'Auszeichnung',
  // c18n
  'dcterms:audience': 'FSK',
  ...
  Award: 'Auszeichnung',
  Audience: 'FSK',
  'Regional encoding': 'Regionalcode',
  Detailpage: 'Detailansicht',
  ...
  Drama: 'Drama',
  Fantasy: 'Fantasy',
  Television: 'Fernsehfilm',
  Historical: 'Historienfilm',
  Horror: 'Horror',
  Comedy: 'Komödie',
  Crime: 'Krimi',
  'Short film': 'Kurzfilm',
